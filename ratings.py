...
def get_restaurant_and_ratings(file_name):
    ...
    # sorted_file = [] + restaurant_and_rating_input
    ...
    for line in sorted_file:
        ...
        #if restaurants_and_ratings.get(restaurant_input, rating_input) == 0:
            #restaurants_and_ratings[restaurant_input] = rating_input
